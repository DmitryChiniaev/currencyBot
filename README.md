...
## Backend
В ветке FasterXML используется библиотека Jackson для парсинга API ЦБ РФ. XML Mapper сохраняет данные в ArrayList. В ячейках хранятся объекта класса Valute, поля которого соответствуют атрибутам XML. 

В ветке master репозиторий использует [DOM API](https://docs.oracle.com/javase/tutorial/jaxp/dom/readingXML.html) для чтения файлов с курсами валют в формате XML 
